...
/**
 * Collection of \Udoh\Emsa\Model\Address objects
 *
 * @author Josh Ridderhoff <jridderhoff@utah.gov>
 */
class AddressList implements \Iterator, \Countable
{
    /** @var array */
    private $list;
     ...
     * @param \Udoh\Emsa\Model\Address $addressItem
     * @return \Udoh\Emsa\Model\AddressList
     */
    public function add(Address $addressItem)
    {
        $this->list[] = $addressItem;
        return $this;
    }
}
