...
class VocabTable
{
    const MASTER_LOINC = 1;
    const MASTER_CONDITION = 2;
    const MASTER_ORGANISM = 3;
    const CHILD_ORGANISM = 4;
    const CHILD_LOINC = 5;
    const CHILD_DICTIONARY = 4;
    const MASTER_DICTIONARY = 8;
    const MASTER_PFGE = 13;
    const MASTER_ICD = 14;
