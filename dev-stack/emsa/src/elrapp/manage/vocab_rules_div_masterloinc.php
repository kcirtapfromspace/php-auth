...
<div id="rule_mod_cmr_dialog" title="Add/Edit LOINC-Based Case Management Rule">
	<form id="rule_mod_cmr_form" method="GET">
		...
		<select class="ui-corner-all" style="margin: 0;" name="rulemod_cmr_application" id="rulemod_cmr_application" title="Values will be transformed for this application">
		...
		<div id="rulemod_cmr_condition_container">
			<div class="rulemod_condition" id="rulemod_cmr_condition_1">
				...
				<select class="ui-corner-all" style="margin: 0;" name="rulemod_cmr_operator[1]" id="rulemod_cmr_operator_1" title="Choose a comparison type">
					<option value="0" selected>--</option>
				</select>
				<select aria-label="Choose a test result" class="ui-corner-all" style="margin: 0; max-width: 20em;" name="rulemod_cmr_operand_value[1]" id="rulemod_cmr_operand_value_1">
					<option value="0" selected>--</option>
				</select>
			</div>
		</div>
		...
		<table>
			<tbody>
				<tr>
					...
					<td>
						<select class="ui-corner-all" style="margin: 0;" name="rulemod_new_cmr" id="rulemod_new_cmr" title="Create a new Morbidity event based on this test result?">
				...
				<tr>
					...
					<td>
						<select class="ui-corner-all" style="margin: 0;" name="rulemod_update_cmr" id="rulemod_update_cmr" title="Update an existing CMR (if found)?">
							<option value="t" selected>Yes</option>
							<option value="f">No</option>
						</select>
					</td>
				...
				<tr>
					...
					<td>
						<select class="ui-corner-all" style="margin: 0;" name="rulemod_is_surveillance" id="rulemod_is_surveillance" title="If creating a new CMR, create as a Surveillance Event?">
				...
				<tr>
					...
					<td>
						<select class="ui-corner-all" style="margin: 0;" name="rulemod_state_case_status" id="rulemod_state_case_status" title="For a new Morbidity event, set this State Case Status.">
